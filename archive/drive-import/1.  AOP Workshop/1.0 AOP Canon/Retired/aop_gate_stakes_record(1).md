...
**Stored asymmetry is a live, movable axis.** With zero drive, structure alone drives
\|Ξ\| from 0 to ~2 bits. The estimator is not pinned at zero by construction — **GO
