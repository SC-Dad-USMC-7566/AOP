...
- *Why:* OAI listed this as a **P0 stop-ship** item ("Binding → rest frame / clock / proper time / present tense"). The Claude-compiled P0 Adjudication Matrix — this session's own recommendation, "not final dispositions and not canon" — *disagreed with that severity* and downgraded it to a "minor phrasing defect." The softened operational-criterion reading applied here follows the matrix's recommended disposition, **pending Ben's adjudication of the matrix** — neither the severity downgrade nor this wording has been ruled on by Ben. **This is the edit most worth Ben's eyes.**
