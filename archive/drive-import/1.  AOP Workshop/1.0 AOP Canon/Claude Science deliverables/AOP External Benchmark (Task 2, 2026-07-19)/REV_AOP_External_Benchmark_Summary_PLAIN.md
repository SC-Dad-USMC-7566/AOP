...
3. **Does AOP beat the simple rival?** — *Yes, by the margin we set in advance.* We scored a one-number rival ("how much chemical traffic flows through this gene"). AOP won on essentiality by exactly the pre-registered margin, and the rival was completely blind to the backup-team pairs from test 2. Worth noting honestly: on real metabolism the simple rival was itself a decent classifier (much better than it was on the toy), so AOP's win is real but not a blowout.
