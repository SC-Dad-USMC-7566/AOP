...
CITE-DON'T-INVENT (all verified against primary sources; see the proposal .md):
  ...
  * Rose, Proc. IEEE 86 (1998) 2210 [doi:10.1109/5.726788] (deterministic
    annealing); Tishby, Pereira & Bialek 1999 (information bottleneck); Gedeon et
    al., Entropy 24 (2022) [Symmetry-Breaking Bifurcations of the IB]: a hard
...
annealed soft-partition, anchored by Rose/Tishby/Gedeon). (C) SYNTHESIS (a
